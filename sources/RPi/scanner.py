...
v=0x100
b=0x1
couleurs={"couleur.blanc":100*r+100*v+100*b,
"couleur.vert":0*r+100*v+0*b,
"couleur.bleu":0*r+0*v+100*b,
"couleur.rose":100*r+50*v+100*b}

scancodes = {
    # Scancode: ASCIICode
    0: None, 1: u'ESC', 2: u'1', 3: u'2', 4: u'3', 5: u'4', 6: u'5', 7: u'6', 8: u'7', 9: u'8',
    10: u'9', 11: u'0', 12: u'-', 13: u'=', 14: u'BKSP', 15: u'TAB', 16: u'a', 17: u'w', 18: u'e', 19: u'r',
...
def getDevice():
    print("looking for scanners ...",end="")
    devices = [evdev.InputDevice(path) for path in evdev.list_devices()]
    for d in devices:
        #print(d)
        if "Scanner" in d.name:
            scanners[d.phys] = d
            scanners[d.phys].couleur = couleurs["couleur.blanc"]
            yield d
            #print("found: {}".format(d.phys))
    print("finish")
    ...
    async for ev in dev.async_read_loop():
        if ev.type == ecodes.EV_KEY:
            ...
            if data.keystate ==1 and data.scancode != 42 :
                if data.scancode == 28:
                    print(scanvalue)
                    if "couleur" in scanvalue:
                        hoooputain(dev.phys,scanvalue)
                    else:
